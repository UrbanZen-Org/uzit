...
<?php get_header(); ?>
    ...
    <div class="sliderWrapper">
        ...
        <div id="slider" class="flexslider">
                   ...
                   <div class="sliderLogo" style="display:none;"><a href="<?php echo home_url(); ?>"><img alt="" src="<?php echo ot_get_option('logo') ?>" /></a></div>
 ...
 jQuery('#carousel').flexslider({
      ...
      jQuery('#slider').flexslider({
        ...
        animationSpeed: <?php echo ot_get_option('speed_homepage') ?>, 
        controlNav: false,
        animationLoop: true,
