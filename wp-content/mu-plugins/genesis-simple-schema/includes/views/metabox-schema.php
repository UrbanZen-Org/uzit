...
<!--
	<tr valign="top">
		<th scope="row"><label for=""><?php _e( '', 'genesis-simple-schema' ); ?></label></th>
		<td>
			<p><input class="large-text" type="text" name="genesis_simple_schema[]" id="" value="<?php echo esc_attr( genesis_get_custom_field( '' ) ); ?>" /></p>
		</td>
	</tr>
-->
</tbody>
